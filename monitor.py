...
class FlowTracker:
    ...
    Network traffic may be split across packets, so this stores recent TCP payloads
    from the same connection and hashes the rolling stream buffer.
    """
...
def start_live_monitor(
    ...
    If a packet payload hash or rolling TCP stream hash matches the malicious hash list,
    an alert dictionary is sent to alert_callback.
    """
    ...
    def process(packet) -> None:
        ...
        # Check individual packet payload hash.
